...
{% include interactive-ai-value.html %}
...
2. **How will value be measured in production, not only in a pilot?**
3. **Why is AI better than a simpler alternative such as rule redesign, search, or standard software?**
4. **What has to change in the way people work for the value to appear?**
5. **Would the benefit still matter after integration, review, support, and adoption effort are included?**
