...
1. **Understanding the AI Landscape** — What AI is, why it matters now, and how the external environment is changing
2. **AI Strategy and Value Creation** — Where AI creates value, how to source capability, and how to design a practical roadmap
3. **AI Governance, Risk, and Leadership** — How to assign accountability, manage risk, and prepare for compliance scrutiny
4. **The Future of AI-Driven Organisations** — How leaders should think about autonomy, critical sectors, trust, and long-term positioning
